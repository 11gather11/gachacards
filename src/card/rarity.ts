...
export const RARITY_PRESETS: readonly RarityPreset[] = [
  {
    ...
    flash: 0.15,
    rainbowFrame: false,
    particle: { kind: "none", count: 0, colors: ["#ffffff"] },
    entrance: "fade",
  },
  {
    id: "blue",
    ...
    flash: 0.25,
    rainbowFrame: false,
    particle: { kind: "dust", count: 26, colors: ["#9fd8ff", "#ffffff"] },
    entrance: "rise",
  },
  {
    id: "green",
    ...
    flash: 0.35,
    rainbowFrame: false,
    particle: { kind: "dust", count: 44, colors: ["#8cf3ac", "#e9fff1", "#3ddc7f"] },
    entrance: "rise",
  },
  {
    id: "red",
    ...
    flash: 0.55,
    rainbowFrame: false,
    particle: { kind: "spark", count: 70, colors: ["#ff6a4d", "#ffb98a", "#fff0e0"] },
    entrance: "zoom",
  },
  {
    id: "gold",
    ...
    flash: 0.75,
    rainbowFrame: false,
    particle: { kind: "spark", count: 100, colors: ["#ffd24d", "#fff2b8", "#ffffff"] },
    entrance: "slam",
  },
  {
    id: "rainbow",
